        ...
        <div class="privacy_container">
            <div class="privacy_box">
                ...
                <div class="privacy_info_content">
                    ...
                    your order. After the transaction, all kinds of card information is automatically deleted without any caches left behind. We are tracking you logging history from website to 
                ...
                <div class="privacy_info_content">
                    ...
                    Mostly it is the demonstration of the knowledge of person 
                    behind this product. The website is not fully
                    functional without a varyatis of things to offer, but
                    the module is a simple and 100% working 
                    system that can bring 
                    success to the intrested companies
                </div>
                ...
                <div class="privacy_info_content">
                    <strong>It is</strong> Simple, team doesn't exist. It's one guy who is trying to make good functional and looking e-coomerece website for profolio. :)
                </div>
                ...
                <div class="privacy_info_content">
                    ...
                    add another functionality to the website. Anyway future looks bright.
                </div>
                <h2 id="findus_content">How to contact us</h2>
                <div class="privacy_info_content">
                    <strong>You</strong> can try to use the <a href="support.php">contact support</a> button or if we are talking about how to find our company's location we have bad news for you. there is only one domain
